...
Revises: 
Create Date: 2019-09-24 15:29:25.777230
...
def upgrade():
    ...
    op.create_table('menu',
                    ...
                    sa.Column('menu_name', sa.String(length=60),
                              nullable=False),
    ...
    op.create_table('role_permission',
                    ...
                    sa.PrimaryKeyConstraint('org_id', 'role_id',
                                            'permission_id')
                    )
    op.create_index(op.f('ix_role_permission_org_id'), 'role_permission',
                    ['org_id'], unique=False)
    op.create_index(op.f('ix_role_permission_permission_id'),
                    'role_permission', ['permission_id'], unique=False)
    op.create_index(op.f('ix_role_permission_role_id'), 'role_permission',
    ...
    op.create_index(op.f('ix_user_org_role_org_id'), 'user_org_role',
                    ['org_id'], unique=False)
    op.create_index(op.f('ix_user_org_role_role_id'), 'user_org_role',
                    ['role_id'], unique=False)
    op.create_index(op.f('ix_user_org_role_user_id'), 'user_org_role',
                    ['user_id'], unique=False)
    ...
    op.create_index(op.f('ix_user_project_role_org_id'), 'user_project_role',
                    ['org_id'], unique=False)
    op.create_index(op.f('ix_user_project_role_project_id'),
                    'user_project_role', ['project_id'], unique=False)
    op.create_index(op.f('ix_user_project_role_role_id'), 'user_project_role',
                    ['role_id'], unique=False)
    op.create_index(op.f('ix_user_project_role_user_id'), 'user_project_role',
                    ['user_id'], unique=False)
    op.create_table('job',
    ...
    op.create_table('query',
                    ...
                    sa.Column('created_at', sa.DateTime(), nullable=True),
                    sa.Column('modified_at', sa.DateTime(), nullable=True),
                    sa.ForeignKeyConstraint(['db_connection_id'], [
    ...
    op.create_index(op.f('ix_query_db_connection_id'), 'query',
                    ['db_connection_id'], unique=False)
    op.create_index(op.f('ix_query_project_id'), 'query', ['project_id'],
                    unique=False)
...
def downgrade():
    ...
    op.drop_table('job')
    op.drop_index(op.f('ix_user_project_role_user_id'),
                  table_name='user_project_role')
    op.drop_index(op.f('ix_user_project_role_role_id'),
                  table_name='user_project_role')
    op.drop_index(op.f('ix_user_project_role_project_id'),
                  table_name='user_project_role')
    op.drop_index(op.f('ix_user_project_role_org_id'),
                  table_name='user_project_role')
    ...
    op.drop_index(op.f('ix_role_permission_role_id'),
                  table_name='role_permission')
    op.drop_index(op.f('ix_role_permission_permission_id'),
                  table_name='role_permission')
    op.drop_index(op.f('ix_role_permission_org_id'),
                  table_name='role_permission')
