            ...
            <div>
                <table>
                    <tr>
                        ...
                        <td>
                            <label className="main_titles userProfileTitle">
                                User Profile
                            </label>
                        </td>
                    </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <TextField
                                    ...
                                    margin="normal"
                                    readOnly
                                    value="user1@accionlabs.com"
                                />
                            </td>
                            <td>
                                <Button className="button-colors userSubmitButton">
                                    Submit
                                </Button>
                            </td>
                        </tr>
                    ...
                    <div>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <label className="userProfileProjectLabel">
                                        Set Default Project
                                    </label>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <Select
                                        ...
                                        onChange={item =>
                                            this.handleOrgChange(item)
                                        }
                                    >
                                        {this.renderOrgListOptions().map(
                                            (data, index) => (
                                                <MenuItem
                                                    key={index}
                                                    value={data.value}
                                ...
                                <td>
                                    <Select
                                        ...
                                        onChange={item =>
                                            this.handleProjectChange(item)
                                        }
                                    >
                                        {this.renderProjectListOptions().map(
                                            (data, index) => (
                                                <MenuItem
                                                    key={index}
                                                    value={data.value}
