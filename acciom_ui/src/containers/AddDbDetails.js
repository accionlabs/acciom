					...
					<Panel.Body>
						<Form className="adddblabels" noValidate onSubmit={this.formSubmit} horizontal>
							<FormGroup controlId="formControlsConnName">
								...
								<Col sm={8}><FormControl value={this.state.formData.db_connection_name} type="textbox" name="db_connection_name" className="addDBDetailsEditbox" maxlength="50" onChange={this.handleInputChange} /></Col>
							</FormGroup >
							<FormGroup controlId="formControlsDbType">
								<Col sm={4}><ControlLabel>Database Type</ControlLabel></Col>
								<Col sm={8}><FormControl value={this.state.formData.db_type}  className="addDBDetailsEditbox" type="textbox" name="db_type" maxlength="50" onChange={this.handleInputChange} /></Col>
							</FormGroup >
							<FormGroup controlId="formControlsDbName">
								<Col sm={4}><ControlLabel>Database Name</ControlLabel></Col>
								<Col sm={8}><FormControl value={this.state.formData.db_name}  className="addDBDetailsEditbox" type="textbox" name="db_name" maxlength="50" onChange={this.handleInputChange} /></Col>
							</FormGroup >
							<FormGroup controlId="formControlsHostName">
								<Col sm={4}><ControlLabel>Host Name</ControlLabel></Col>
								<Col sm={8}><FormControl value={this.state.formData.db_hostname}  className="addDBDetailsEditbox" type="textbox" name="db_hostname" maxlength="50"  onChange={this.handleInputChange} /></Col>
							</FormGroup >
							<FormGroup controlId="formControlsUsername">
								<Col sm={4}><ControlLabel>User Name</ControlLabel></Col>
								<Col sm={8}><FormControl value={this.state.formData.db_username}  className="addDBDetailsEditbox" type="textbox" name="db_username" maxlength="50"  onChange={this.handleInputChange} /></Col>
							</FormGroup >
							<FormGroup controlId="formControlsPassword">
								<Col sm={4}><ControlLabel>Password</ControlLabel></Col>
								<Col sm={8}><FormControl value={this.state.formData.db_password}  className="addDBDetailsEditbox" type="password" name="db_password" maxlength="50" onChange={this.handleInputChange} /></Col>
							</FormGroup >
