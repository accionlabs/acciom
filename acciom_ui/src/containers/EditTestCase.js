        ...
        <TableRow className="table-create-suite-row">
          <Fragment>
                ...
                <TableCell>
                    ...
                    <IconButton>
                    <BorderColorRoundedIcon onClick={(e) => {this.showDialog(index,8)}} style={{ color: '#69717D' }}/></IconButton></Tooltip>:
                    <Tooltip
                ...
                <TableCell>
                  {eachrow.target_query?<Tooltip title="Edit Query" placement="top"><IconButton>
                      <BorderColorRoundedIcon onClick={(e) => {this.showDialog(index,9)}} style={{ color: '#69717D' }} /></IconButton></Tooltip>:
                      <Tooltip
                ...
                {this.showMinus()?
                            <Tooltip title="Remove Testcase"
                                placement="top">
                            <IconButton disabled={this.state.CaseData_Description.length == 1} className="editButtonDisabled" onClick={() => this.deleteRow(index)}>
                                <MinusCircle />
                            </IconButton>
                            </Tooltip>
                            :""
